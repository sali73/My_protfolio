...
const Offer = () => {
    ...
    return (
        <>
            <Layout>
                <h3>MY OFFER </h3>
                <h5>A full-stack software engineer with over 4 years of experience.</h5>
                ...
                <h5>My current toolset includes Elixir Language  Ruby & Ruby on Rails, React,Redux and all the other various frameworks, libraries and technologies related to them.</h5>
                ...
                <h6>If your initial thought is that I can’t be the best in everything, it's okay. Send the design job to someone else, and I will take care of all the code development, or whatever other role you see me best in.
                    ...
                    In cases when you already have an existing team, but you would still use some help, contact me as well. I’ll fit in very quickly, I promise.</h6>
